                  ...
                  <div class="tj-post-details__container">
                     <article class="tj-single__post">
                        <div class="tj-post__thumb">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/images/faq-5-thumb1.jpg" alt="" />

                           <a href="#" class="category">My Expertises</a>
                        </div>

                        <div class="tj-post__content">
                           <h3 class="tj-post__title entry-title"><span>07.</span> UI/UX Design
                           </h3>
...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-shape.png" alt="img">
                           ...
                           <div class="widget_title">
                              <h3 class="title">Other Expertise</h3>
                           </div>
                           <ul>
                              <li class="active">
                                 <button fdprocessedid="3a30ld">
                                    Branding Design
                                 </button>
                              </li>
                              <li>
                                 <button fdprocessedid="ag6ox">
                                    3D Animation
                                 </button>
                              </li>
                              <li>
                                 <button fdprocessedid="ztq5wd">
                                    UI/UX Design
                                 </button>
                              </li>
                              <li>
                                 <button fdprocessedid="b2luqa">
                                    Web Design
                                 </button>
                              </li>
                              <li>
                                 <button fdprocessedid="yx0e58">
                                    App Design
                                 </button>
                                 <li>
                                 <button fdprocessedid="3a30ld">
...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-shape.png" alt="img">
                           ...
                           <form action="index.html">
                              <div class="form_group">
                                 <input type="text" name="name" id="name" placeholder="Name" autocomplete="off" fdprocessedid="4y0u3p">
                              </div>
                              <div class="form_group">
                                 <input type="email" name="semail" id="semail" placeholder="Email" autocomplete="off" fdprocessedid="oejigx">
                              </div>
                              <div class="form_group">
                                 <textarea name="smessage" id="smessage" placeholder="Your message" autocomplete="off"></textarea>
                              </div>
                              <div class="form_btn">
                                 <button class="btn tj-btn-primary" type="submit" fdprocessedid="fpf87l">Send Message<i class="fa-solid fa-arrow-right"></i></button>
                              </div>
                           </form>
                        </div>
                  </div>
