                     ...
                     <article class="tj-single__post">
                        ...
                        <div class="tj-post__content">
                           <div class="tj-post__meta entry-meta">
                              <span><i class="fa-solid fa-user"></i> <a href="#">By Admin</a></span>
...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-shape.png" alt="img">
                              ...
                              <div class="navigation-post_img">
                                 <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/1.jpg" alt="" /> </a>
                              </div>
                              <div class="tj-content">
                                 <div class="post_pagination_nav"><i class="fa-solid fa-arrow-left"></i>previous</div>
...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-shape.png" alt="img">
                              ...
                              <div class="tj-content">
                                 <div class="post_pagination_nav">Next<i class="fa-solid fa-arrow-right"></i>
                                 </div>
                                 <div class="post_pagination_title">
                                    <h5 class="title">
                              ...
                              <div class="navigation-post_img">
                                 <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/2.jpg" alt="" /> </a>
                              </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="tj-latest__comments">
                              <ul>
                                 <li class="tj__comment">
                                    <div class="tj-comment__wrap">
                                       <div class="comment__avatar">
                                          <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/user-1.jpg" />
                                       </div>
                                    ...
                                    <ul class="children">
                                       <li class="tj__comment">
                                          <div class="tj-comment__wrap">
                                             <div class="comment__avatar">
                                                <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/user-2.jpg" />
                                             </div>
                                             <div class="comment__text">
                                                <div class="avatar__name">
                                       ...
                                       <li class="tj__comment">
                                          <div class="tj-comment__wrap">
                                             <div class="comment__avatar">
                                                <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/user-3.jpg" />
                                             </div>
                                             <div class="comment__text">
                                                <div class="avatar__name">
                                 ...
                                 <li class="tj__comment">
                                    <div class="tj-comment__wrap">
                                       <div class="comment__avatar">
                                          <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/user-4.jpg" />
                                       </div>
                                       <div class="comment__text">
                                          <div class="avatar__name">
...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-shape.png" alt="img">
                           ...
                           <form action="index.html" class="tj-post-comment__form">
                              ...
                              <button class="tj-btn-primary submit" type="submit">Post Comment <i class="fa-solid fa-arrow-right"></i></button>
                           </form>
                        </div>
                     </div>
                  </div>
...
<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-shape.png" alt="img">
                        ...
                        <ul>
                           <li>
                              <div class="recent-post_thumb">
                                 <a href="blog-details.html">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumb-1.jpg" alt="" />
                                 </a>
                              </div>

                              <div class="recent-post_content">
                                 <div class="tj-post__meta entry-meta">
                                    <span><i class="fa-solid fa-calendar"></i>Jan 2024</span>
                                    <span><i class="fa-solid fa-comment"></i><a href="#"> (3)</a></span>
                                 </div>
                           ...
                           <li>
                              <div class="recent-post_thumb">
                                 <a href="blog-details.html">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumb-2.jpg" alt="" />
                                 </a>
                              </div>
                           ...
                           <li>
                              <div class="recent-post_thumb">
                                 <a href="blog-details.html">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/post-thumb-3.jpg" alt="" />
                                 </a>
                              </div>
                              <div class="recent-post_content">
                                 <div class="tj-post__meta entry-meta">
