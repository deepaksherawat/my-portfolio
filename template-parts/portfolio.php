                        ...
                        <div class="swiper portfolio-slider-5">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="portfolio-item style-5 wow fadeInUp" data-wow-delay=".3s">
                                        <div class="image-box">
                                            <a class="modal-popup" href="#portfolio-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/work-1.jpg" alt="Images" /></a>
                                        </div>
                                        <div class="content-box">
                                            <div class="portfolio-text">
                                                <h5 class="portfolio-title"><a class="modal-popup"
                                                        href="#portfolio-wrapper">Deloitte</a></h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="portfolio-item style-5 wow fadeInUp" data-wow-delay=".5s">
                                        <div class="image-box">
                                            <a class="modal-popup" href="#portfolio-wrapper">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/work-2.jpg" alt="Images" />
                                            </a>
                                        </div>
                                        <div class="content-box">
                                            <div class="portfolio-text">
                                                <h5 class="portfolio-title"><a class="modal-popup"
                                                        href="#portfolio-wrapper">New Age</a></h5>
                                                <p>Project was about precision and information.</p>
                                            </div>
                                            <div class="portfolio-arrow">
                                                <a class="modal-popup" href="#portfolio-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="portfolio-item style-5 wow fadeInUp" data-wow-delay=".7s">
                                        <div class="image-box">
                                            <a class="modal-popup" href="#portfolio-wrapper">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/work-3.jpg" alt="Images" />
                                            </a>
                                        </div>
                                        <div class="content-box">
                                            <div class="portfolio-text">
                                                <h5 class="portfolio-title"><a class="modal-popup"
                                                        href="#portfolio-wrapper">Sebastian</a></h5>
                                                <p>Project was about precision and information.</p>
                                            </div>
                                            <div class="portfolio-arrow">
                                                <a class="modal-popup" href="#portfolio-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="portfolio-item style-5 wow fadeInUp" data-wow-delay=".9s">
                                        <div class="image-box">
                                            <a class="modal-popup" href="#portfolio-wrapper">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/work-1.jpg" alt="Images" />
                                            </a>
                                        </div>
                                        <div class="content-box">
                                            <div class="portfolio-text">
...
<img src="./<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/modal-img.jpg" alt="" />
</div> -->
